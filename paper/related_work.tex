...
machines in a Brazilian poultry-feed pellet plant at 1\,Hz for
approximately 111 days. IMDELD is the benchmark used throughout this
...
\midrule
\textbf{This work}                   & \textbf{GMM--HMM $\rightarrow$ Seq2Seq LSTM $\rightarrow$ optimisation} & \textbf{IMDELD (industrial)} & \textbf{no} & \CIRCLE & \CIRCLE & \CIRCLE & \CIRCLE \\
\bottomrule
\end{tabular}
